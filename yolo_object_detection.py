...
labelsPath = os.path.sep.join([args["yolo"], "clearbot.names"])
...
weightsPath = os.path.sep.join([args["yolo"], "clearbot.weights"])
configPath = os.path.sep.join([args["yolo"], "clearbot.cfg"])
